...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMB] = LAYOUT(
        ...
        KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_COLN,                                                KC_LCBR, KC_LBRC, KC_LPRN, KC_GRV, KC_QUOT,
        KC_PIPE, KC_BSLS, KC_PLUS, KC_EQL, KC_MINS,                                                 KC_RCBR, KC_RBRC, KC_RPRN, KC_LABK, KC_RABK,
        TO(NUMB), TO(SYMB),                                                                         TO(BASE), TO(NUMB)),
    [ARRW] = LAYOUT(
        LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), _______,                                    LCTL(KC_B), LALT(KC_4), LALT(KC_3), LALT(KC_2), LALT(KC_1),
        ...
        TO(NUMB), TO(BASE),                                                                         TO(ARRW), TO(NUMB)),
    [NUMB] = LAYOUT(
